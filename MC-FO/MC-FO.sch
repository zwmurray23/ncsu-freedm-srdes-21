...
Wire Wire Line
	7250 2200 6550 2200
$Sheet
S 1500 4500 1000 500 
U 6176CA10
F0 "Emitter4" 50
F1 "Emitter_Circuits.sch" 50
F2 "EPWM" I R 2500 4650 50 
F3 "5V" I R 2500 4800 50 
F4 "GND2" I R 2500 4900 50 
$EndSheet
$Sheet
S 1500 5500 1000 500 
U 6176CA81
F0 "Emitter5" 50
F1 "Emitter_Circuits.sch" 50
F2 "EPWM" I R 2500 5600 50 
F3 "5V" I R 2500 5750 50 
F4 "GND2" I R 2500 5900 50 
$EndSheet
$Sheet
S 1500 6500 1000 500 
U 6176CAE4
F0 "Emitter6" 50
F1 "Emitter_Circuits.sch" 50
F2 "EPWM" I R 2500 6600 50 
F3 "5V" I R 2500 6750 50 
F4 "GND2" I R 2500 6900 50 
$EndSheet
$Sheet
...
F0 "Emitter1" 50
F1 "Emitter_Circuits.sch" 50
F2 "EPWM" I R 2500 1600 50 
F3 "5V" I R 2500 1750 50 
F4 "GND2" I R 2500 1900 50 
$EndSheet
$Sheet
...
F0 "Emmiter2" 50
F1 "Emitter_Circuits.sch" 50
F2 "EPWM" I R 2500 2600 50 
F3 "5V" I R 2500 2750 50 
F4 "GND2" I R 2500 2900 50 
$EndSheet
$Sheet
...
Wire Wire Line
	4950 5600 4100 5600
$Sheet
S 4950 5500 1000 500 
U 61724A08
F0 "Detector2" 50
F1 "Detector_Circuits.sch" 50
F2 "DPWM" I L 4950 5600 50 
F3 "5V" I L 4950 5750 50 
F4 "GND2" I L 4950 5900 50 
$EndSheet
$Sheet
S 4950 4500 1000 500 
U 6171C819
F0 "Detector1" 50
F1 "Detector_Circuits.sch" 50
F2 "DPWM" I L 4950 4600 50 
F3 "5V" I L 4950 4750 50 
F4 "GND2" I L 4950 4900 50 
$EndSheet
Wire Wire Line
	4950 4600 4100 4600
$Sheet
S 7250 1150 1000 500 
U 6175C442
F0 "Voltage Regulation" 50
F1 "Voltage_Regulation.sch" 50
F2 "Vdd" I R 8250 1300 50 
F3 "3V3" I L 7250 1550 50 
...
Wire Wire Line
	3500 2750 3500 3850
$Sheet
S 7250 2100 1000 500 
U 6175812E
F0 "Status LED" 50
F1 "MC-LED.sch" 50
F2 "StatusLED" I L 7250 2200 50 
F3 "3V3" I L 7250 2300 50 
...
24V
$Comp
L Connector:DB25_Female J21
U 1 1 6179E2FC
P 8850 4600
F 0 "J21" H 9030 4646 50  0000 L CNN
F 1 "DB25_Female" H 9030 4555 50  0000 L CNN
F 2 "Connector_Dsub:DSUB-25_Female_Horizontal_P2.77x2.54mm_EdgePinOffset9.40mm" H 8850 4600 50  0001 C CNN
...
U 1 1 617AD6F4
P 6700 2950
F 0 "#PWR022" H 6700 2700 50  0001 C CNN
...
U 1 1 617AF034
P 3750 7350
F 0 "#PWR021" H 3750 7100 50  0001 C CNN
...
F 1 "GND1" H 8255 5527 50  0000 C CNN
...
F 1 "GND2" H 8455 5727 50  0000 C CNN
